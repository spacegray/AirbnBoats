...
// (this query should use the currentUser scope since the hashedPassword 
...
// Both restoreUser and requireAuth will be applied 
// as a pre-middleware to route handlers where needed.
